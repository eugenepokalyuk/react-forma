...
const ProfileCard: React.FC<ProfileCardProps> = ({ name, tag, description, image }) => {
    return (
        <div className='bg-[#111111]/[.16] p-3 space-y-2 rounded-xl'>
            <div className="grid grid-cols-10 rounded-xl">
                <div className='col-span-2'>
                    <img src={image} alt="User" className="w-12 h-12 rounded-full border-2 border-[#BBFF00] object-cover" />
                </div>
